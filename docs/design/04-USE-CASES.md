...
5. System analyzes pitch/timing using Autocorrelation.
...
3. AI generates continuation notes.
4. User previews.
...
1. System presents audible alternatives.
2. User listens to options.
3. User selects preferred option.
4. System applies selected musical option.
